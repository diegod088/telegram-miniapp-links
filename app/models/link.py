...
class LinkLike(Base):
    """Many-to-Many association for User likes on Links."""
    __tablename__ = "user_link_likes"
    ...
    __table_args__ = (
        Index("ix_user_link_likes_user_link", "user_id", "link_id"),
    )

    def __repr__(self) -> str:
        return f"<LinkLike user={self.user_id} link={self.link_id}>"


class LinkDislike(Base):
    """Many-to-Many association for User dislikes on Links."""
    __tablename__ = "user_link_dislikes"
    ...
    __table_args__ = (
        Index("ix_user_link_dislikes_user_link", "user_id", "link_id"),
    )
